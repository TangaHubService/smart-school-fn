...
export function ParentReportCardsPage() {
  ...
  const reportCardsQuery = useQuery({
    ...
    queryFn: () =>
      getParentReportCardsApi(auth.accessToken!, {
        ...
        <div className="grid gap-4">
          ...
          {reportCardsQuery.isPending ? (
            ...
            <StateView
              ...
              message="Retry to load report cards."
              action={
                <button
                  type="button"
                ...
                >
                  <div className="grid gap-1">
                    ...
                    <p className="text-sm text-slate-600">
                      {item.term.name} · {item.classRoom.name}
                    </p>
                  </div>
            ...
            <EmptyState
              ...
              message="Published report cards for your linked students will appear here."
            />
          )}
        </div>
      </SectionCard>
