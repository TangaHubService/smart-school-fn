...
const reasons = [
  {
    ...
    desc: 'Designed for real school operations and governance workflows.',
  },
  {
    icon: Users,
    title: 'Expert Support',
    desc: 'Guidance for onboarding, setup, and institutional adoption.',
  },
  {
    icon: Clock,
    title: 'Always Available',
    desc: 'Cloud-based access for administrators, staff, and learners.',
  },
  {
    icon: Star,
    title: 'Clear Outcomes',
    desc: 'Track progress with attendance, assessments, and reports.',
  },
  {
    icon: Play,
    title: 'Interactive Learning',
    desc: 'Practical course content and assignment workflows in one place.',
  },
  {
    icon: ArrowRight,
    title: 'Career Readiness',
    desc: 'Build practical capabilities aligned to market demand.',
  },
];
      ...
      >
        ...
        <div className="relative mx-auto w-full max-w-6xl px-4 text-center sm:px-6 lg:px-8">
          <div className="mx-auto max-w-3xl">
            ...
            <h1 className="text-2xl font-bold font-display leading-tight tracking-tight text-white sm:text-3xl lg:text-4xl">
              Our Leading Exam Partner for Academic and Professional Success
            </h1>
            <p className="mx-auto mt-6 hidden max-w-4xl text-lg font-medium leading-relaxed text-gray-100 md:block">
              Smart School empowers learners with practical, market-relevant skills through a
              digital platform that automates exams, standardizes marking, and delivers real-time
              insights, reducing teachers’ workload while improving fairness, learning outcomes, and
              access to quality, lifelong education across the country for all.
            </p>
        ...
        <div className="mx-auto w-full max-w-6xl px-4 sm:px-6 lg:px-8">
          <div className="mb-14 text-center">
            ...
            <p className="mx-auto mt-5 max-w-3xl text-lg text-slate-500">
              Purpose-built design and practical workflows for institutions, educators, and
              learners.
            </p>
          </div>
          <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
            {reasons.map((item) => (
              ...
              >
                ...
                <h3 className="text-lg font-bold tracking-tight text-slate-900 transition-colors group-hover:text-white">
                  {item.title}
                </h3>
          ...
          <div className="relative overflow-hidden rounded-3xl bg-brand-500 p-12 text-center text-white shadow-[0_30px_60px_rgba(30,90,168,0.30)]">
            ...
            <div className="relative">
              ...
              <p className="mx-auto mt-4 max-w-2xl text-lg text-white/90">
                Join thousands of learners already transforming their careers through practical
                digital education.
              </p>
