  ...
  return (
    <div className="grid gap-5">
        ...
        <div className="grid gap-3 lg:grid-cols-[minmax(0,1fr)_auto] lg:items-center">
          <div className="relative">
            <input
              ...
              className="h-12 w-full rounded-2xl border border-brand-200 bg-white px-4 text-sm text-brand-900 outline-none placeholder:text-brand-400 focus:border-brand-400"
              aria-label="Search my courses"
            />
          </div>
          <div className="inline-flex items-center gap-3 rounded-2xl border border-brand-200 bg-brand-50 px-4 py-3 text-sm font-semibold text-brand-800">
                          ...
                          >
                            <span className="flex min-w-0 items-center gap-3">
                              ...
                              <span className="min-w-0 flex-1">
                                <span className="block truncate whitespace-nowrap text-base font-bold leading-6 text-brand-900">
                                  {course.title}
                                </span>
                                <span className="mt-2 flex flex-nowrap gap-2 overflow-hidden">
                                  ...
                                  <span className="inline-flex shrink-0 whitespace-nowrap rounded-full bg-brand-100 px-2.5 py-1 text-xs font-semibold text-brand-700">
                                    {course.assignments.length} tests
                                  </span>
                                </span>
                              </span>
                            </span>
                            <span className="mt-1 inline-flex h-8 w-8 shrink-0 items-center justify-center rounded-full border border-brand-200 bg-white text-brand-500">
                              {isExpanded ? (
                            ...
                            <div className="px-4 pb-4">
                              <div className={clsx('grid gap-2 border-l pl-4', accent.rail)}>
                                {course.lessons.length ? (
                                      ...
                                      <div key={lesson.id} className="grid gap-1">
                                        <button
                                          ...
                                          className={clsx(
                                            ...
                                            lessonSelected
                                              ? 'border-brand-200 bg-white text-brand-900 shadow-sm'
                                              : 'border-transparent bg-brand-50/70 text-brand-700 hover:border-brand-100 hover:bg-white',
                                          )}
                                        ...
                                        >
                                          <span className="flex min-w-0 flex-1 items-center gap-3">
                                            ...
                                            <span className="min-w-0 flex-1">
                                              <span className="block truncate whitespace-nowrap text-sm font-semibold leading-5 text-brand-900">
                                                {lesson.title}
                                              </span>
                                              <span className="mt-1 flex flex-nowrap items-center gap-2 overflow-hidden text-xs text-brand-600">
                                                <span className="inline-flex shrink-0 whitespace-nowrap rounded-full bg-white px-2 py-0.5 font-semibold text-brand-700 ring-1 ring-brand-100">
                                              ...
                                              return (
                                                <button
                                                  ...
                                                  className={clsx(
                                                    ...
                                                    isAssignmentSelected
                                                      ? 'border-brand-200 bg-white text-brand-900 shadow-sm'
                                                      : 'border-transparent bg-white/80 text-brand-700 hover:border-brand-100 hover:bg-white',
                                                  )}
                                                ...
                                                >
                                                  <span className="flex min-w-0 flex-1 items-center gap-3">
                                                    ...
                                                    <span className="min-w-0 flex-1">
                                                      <span className="block truncate whitespace-nowrap text-sm font-medium leading-5 text-brand-900">
                                                        {assignment.title}
                                                      </span>
                                                    </span>
                                                  </span>
                                                  <span className="shrink-0 whitespace-nowrap rounded-full bg-white px-2 py-1 text-[11px] font-semibold text-brand-600 ring-1 ring-brand-100">
                                                    {status.label}
                                                  </span>
                                                </button>
                                              );
                                  ...
                                  <p className="rounded-2xl bg-brand-50 px-3 py-3 text-sm text-brand-600">
                                ...
                                {generalAssignments.length ? (
                                  <div className="pt-1">
                                    <p className="px-3 pb-1 text-sm font-semibold text-brand-700">
                                      Course tests
                                    </p>
                                    <div className="ml-4 grid gap-1 border-l border-brand-100 pl-3">
              ...
              <div className="flex min-h-[680px] flex-col">
                <div className="border-b border-brand-100 px-5 py-4">
                  <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
                    <div>
                      <div className="flex flex-wrap items-center gap-2 text-[11px] font-bold uppercase tracking-[0.18em] text-brand-500">
                      ...
                      <h2 className="mt-3 text-2xl font-bold tracking-tight text-brand-900">
                        {readerHeader.title}
                      </h2>
      ...
      {myCoursesQuery.data?.pagination.totalPages && myCoursesQuery.data.pagination.totalPages > 1 ? (
        <div className="flex items-center justify-between rounded-2xl border border-brand-100 bg-white/95 px-4 py-3 text-sm text-brand-700 shadow-soft">
          <span>
    ...
    <section className="rounded-2xl border border-brand-100 bg-brand-50/40 p-5">
      <div className="mb-4 flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
        <div>
          ...
          <h3 className="mt-1 text-xl font-bold tracking-tight text-brand-900">{title}</h3>
                ...
                >
                  <div className="flex items-start justify-between gap-3">
                    <div>
                      ...
                      {lesson.summary ? (
                        <p className="mt-2 line-clamp-2 text-sm text-brand-600">{lesson.summary}</p>
                      ) : null}
                    </div>
    ...
    <div className="grid gap-4">
      ...
      >
        {lesson.body ? (
          <RichContent
            html={lesson.body}
            className="rich-content rounded-2xl bg-white p-5 text-[15px] leading-7 text-brand-700"
          />
        ) : (
          <div className="rounded-2xl border border-dashed border-brand-200 bg-white px-4 py-5 text-sm text-brand-600">
...
function AssignmentDetailCard({
  ...
  return (
    <div className="grid gap-4">
      ...
      >
        {assignment.mySubmission ? (
          <div className="rounded-2xl bg-white p-5 text-sm text-brand-700 shadow-sm">
            ...
            {assignment.mySubmission.gradePoints !== null ? (
              <div className="mt-4 rounded-2xl border border-brand-100 bg-brand-50 px-4 py-3">
                ...
                {assignment.mySubmission.feedback ? (
                  <p className="mt-2 text-brand-700">{assignment.mySubmission.feedback}</p>
                ) : null}
              </div>
            ) : null}
          </div>
...
function MetricTile({
  ...
  return (
    <div className="rounded-2xl border border-brand-100 bg-white px-4 py-4 shadow-sm">
      <p className="text-xs font-bold uppercase tracking-[0.18em] text-brand-500">{label}</p>
